        ...
        <div class="row">
          <div class="col-md-12"> 
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="input-group">
                          <input type="number" readonly class="form-control" id="grand_total" name="grand_total"/> 
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="home-tab" data-toggle="pill" href="#tabhome" role="tab" aria-controls="tabhome" aria-selected="true">Detail</a>
                </li>
                <li class="nav-item">
